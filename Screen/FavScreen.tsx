...
const FavScreen = () => {
    ...
    useEffect(() => {
        const fetchFavoriteVets = async () => {
            try {
                ...
                const response = await axios.get(`https://80e8-157-100-134-105.ngrok-free.app/vet`, { headers });
    ...
    const handleUpdate = async () => {
        try {
            ...
            await axios.put(`https://80e8-157-100-134-105.ngrok-free.app/vet`, { favoriteVets }, { headers });
