...
const ProfileScreen = () => {
    ...
    useEffect(() => {
        const fetchUserData = async () => {
            try {
                ...
                const response = await axios.get('https://5394-45-184-102-76.ngrok-free.app/user/me', { headers });
    ...
    const handleUpdate = async () => {
        ...
        try {
            ...
            await axios.patch('https://5394-45-184-102-76.ngrok-free.app/user/me', updatedUserData, { headers });
    ...
    const handleEnable2FA = async () => {
        try {
            ...
            const response = await axios.post(`https://5394-45-184-102-76.ngrok-free.app/2fa/enable`, {}, { headers });
