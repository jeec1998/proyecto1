...
const UserListScreen = () => {
  ...
  useEffect(() => {
    const fetchUsers = async () => {
      try {
        ...
        const response = await axios.get('https://7bab-2800-bf0-2401-1128-3197-5a95-cf0-630c.ngrok-free.app/user', { headers });
  ...
  const handleDeleteUser = async (id) => {
    try {
      ...
      await axios.delete(`https://7bab-2800-bf0-2401-1128-3197-5a95-cf0-630c.ngrok-free.app/user/${id}`, { headers });
